...
public class Deposit implements ActionListener{
    ...
    { this.ac=ac;this.pin=pin;
        ...
        heading.setText("Enter your deposit amount :");
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(e.getSource()==insertButton)
        {
            if(pinstore=="")
            {
                JOptionPane.showMessageDialog(frame,"Amount kudra venna!!","Failed",JOptionPane.INFORMATION_MESSAGE);
            }
            try{
                ...
                String query= "UPDATE Atm_users SET Balance="+"'"+(input+bal)+"'"+" WHERE AccountNumber="+"'"+ac+"'"; // query to be run
